                ...
                validator: function (value) {
                    return new Promise(function (resolve, reject) {
                        ...
                        if (!(self instanceof IdValidator) || self.enabled) {
                            ...
                            if (typeof localRefModelName === 'function') {
                                localRefModelName = localRefModelName.call(this, this)
                            }
                            // if `ref` is a model
                            if (!!localRefModelName.modelName) {
                                localRefModelName = localRefModelName.modelName
                            }
                            // if `refPath` exists
                            if (refModelPath) {
